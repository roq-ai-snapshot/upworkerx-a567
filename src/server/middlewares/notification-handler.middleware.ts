...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'application.create': {
    ...
    tenantPath: ['company', 'job', 'application'],
    userPath: [],
  },
  'booking.create': {
    roles: ['business-owner'],
    key: 'job-offer-accepted',
    tenantPath: ['company', 'booking'],
    userPath: [],
  },
  'job.create': { roles: ['freelancer'], key: 'job-posted', tenantPath: ['company', 'job'], userPath: [] },
};
