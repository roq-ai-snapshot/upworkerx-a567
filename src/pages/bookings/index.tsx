...
export function BookingListPage(props: BookingListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getBookings({
        relations: ['job', 'freelancer', 'company'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('job', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('freelancer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'freelancer',
          header: 'Freelancer',
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link
              ...
              href={`/freelancers/view/${record.freelancer?.id}`}
            >
              {record.freelancer?.skills}
            </Link>
          ),
        }
      : null,
